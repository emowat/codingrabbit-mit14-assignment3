...
1. `git remote add upstream https://github.com/emowat/codingrabbit-mit14-assignment3.git` *(one-time setup — links you to the original course repository; skip this if you've already done it once)*
